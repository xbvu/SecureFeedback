...
from SecureWebApp.utils import make_dir, INSTANCE_FOLDER_PATH
...
def configure_blueprints(app):
    ...
    from SecureWebApp.feedback import feedback
    from SecureWebApp.main import main

    for bp in [main, feedback]:
...
def configure_logging(app):
    ...
    from SecureWebApp.utils import make_dir
